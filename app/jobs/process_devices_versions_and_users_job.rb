...
class ProcessDevicesVersionsAndUsersJob < ActiveJob::Base
  ...
  PROCESS_1 = 'ProcessDevicesVersionsAndUsers-screenProperties'
  PROCESS_2 = 'ProcessDevicesVersionsAndUsers-androidDeviceInfo'
  PROCESS_3 = 'ProcessDevicesVersionsAndUsers-googlePlayInfo'
  ...
  def perform(*args)
    ...
    end_date_s = Time.zone.now.strftime(DATE_FORMAT)
    ...
    puts "START PROCESS: #{PROCESS_1} - #{ldl.last_keen_id} - #{ldl.last_keen_date}"
    begin
      screenProperties = Keen.extraction('screenProperties',
                                         timeframe: {start: LAST_DATE_STRING, end: end_date_s},
      ...
      screenProperties.each do |row|
        if (row['test'] && (row['test'] == '' || row['test'] == 'false')) || row['test'].nil?
          ...
          if u_device
            ...
            u_device.device_density = row['density']
            u_device.device_height = row['height']
            u_device.device_width = row['width']
            u_device.device_h_diff = row['worldHDiff']
          ...
          if u_version
            ...
            if u_version.last_play_date < keen_date
              u_version.last_play_date = keen_date
            end
            u_version.save
          else
            u_device.unique_versions.create(game_version: row['version'], play_count: 1, first_play_date: keen_date, last_play_date: keen_date)
          end
        end
      end
      ...
      if screenProperties.size > 0
        ...
        ldl.last_keen_date = DateTime.strptime(screenProperties.last['keen']['timestamp'], DATE_FORMAT)
        ldl.save!
      end
    end while screenProperties.size > 0
    puts "END PROCESS: #{PROCESS_1}"

    ldl = get_ldl(PROCESS_2)
    puts "START PROCESS: #{PROCESS_2} - #{ldl.last_keen_id} - #{ldl.last_keen_date}"
    begin
      androidDeviceInfo = Keen.extraction('androidDeviceInfo',
                                          timeframe: {start: LAST_DATE_STRING, end: end_date_s},
                                          filters: [{operator: 'gt', property_name: 'keen.id', property_value: ldl.last_keen_id}])
      ...
      if androidDeviceInfo.size > 0
        ...
        puts "DATE RANGE: [#{androidDeviceInfo.first['keen']['timestamp']} - #{androidDeviceInfo.last['keen']['timestamp']}]"
      end
      ...
      androidDeviceInfo.each do |row|
        if (row['test'] && (row['test'] == '' || row['test'] == 'false')) || row['test'].nil?
          ...
          u_device = UniqueDevice.find_by(device_id: row['userID'])
          if u_device && (u_device.device_model == '' || u_device.device_device == '')
            u_device.device_model = row['model']
      ...
      if androidDeviceInfo.size > 0
        ldl.last_keen_id = androidDeviceInfo.last['keen']['id']
        ldl.last_keen_date = DateTime.strptime(androidDeviceInfo.last['keen']['timestamp'], DATE_FORMAT)
        ldl.save!
      end
    end while androidDeviceInfo.size > 0
    puts "END PROCESS: #{PROCESS_2}"

    ldl = get_ldl(PROCESS_3)
    puts "START PROCESS: #{PROCESS_3} - #{ldl.last_keen_id} - #{ldl.last_keen_date}"
    begin
      googlePlayInfo = Keen.extraction('googlePlayInfo',
                                          timeframe: {start: LAST_DATE_STRING, end: end_date_s},
                                          filters: [{operator: 'gt', property_name: 'keen.id', property_value: ldl.last_keen_id}])
      ...
      if googlePlayInfo.size > 0
        ...
        puts "DATE RANGE: [#{googlePlayInfo.first['keen']['timestamp']} - #{googlePlayInfo.last['keen']['timestamp']}]"
      end
        ...
        if (row['test'] && (row['test'] == '' || row['test'] == 'false')) || row['test'].nil?
          ...
          if u_device
            ...
            if u_user
              ...
              u_user.user_gender = row['version'] == '2.3.1' || row['version'] == '2.4.1' || row['gender'] != '0' ? row['gender'] : 'UNKNOWN'
      ...
      if googlePlayInfo.size > 0
        ldl.last_keen_id = googlePlayInfo.last['keen']['id']
        ldl.last_keen_date = DateTime.strptime(googlePlayInfo.last['keen']['timestamp'], DATE_FORMAT)
        ldl.save!
      end
    end while googlePlayInfo.size > 0
    puts "END PROCESS: #{PROCESS_3}"

    #Devices that didnt use Google Play
    #UniqueDevice.where(UniqueUser.where("unique_users.unique_device_id = unique_devices.id").exists.not).each {|d| puts d }
  ...
  def check_device()
    ...
    big_list = ["Acer|A1-810|mango|A1-810",
        ...
        #Retail Branding|Marketing Name|Device|Model
        #'',
        'Alcatel|One Touch|4018A|4018A',
        'Alcatel|Idol 2|6037B|6037B',
        'ALPS|706v92|706v92_jbla_fhd|706v92_jbla_fhd',
        #'772',
        'HKC|A072D|A072D|A072D',
        'Lenovo|A680|A680|A680',
        'HTC|Merge|ADR6325|ADR6325',
        'HTC|ADR6330VW|ADR6330VW|ADR6330VW',
        'Alcatel|One Touch|ALCATEL ONE TOUCH 4010A|ALCATEL ONE TOUCH 4010A',
        'Alcatel|One Touch|ALCATEL ONE TOUCH 4030A|ALCATEL ONE TOUCH 4030A',
        'Alcatel|One Touch|ALCATEL ONE TOUCH 4030E|ALCATEL ONE TOUCH 4030E',
        'Alcatel|One Touch|ALCATEL ONE TOUCH 5020A|ALCATEL ONE TOUCH 5020A',
        'Alcatel|One Touch|ALCATEL ONE TOUCH 5020T|ALCATEL ONE TOUCH 5020T',
        'Alcatel|One Touch|ALCATEL ONE TOUCH 5020W|ALCATEL ONE TOUCH 5020W',
        'Alcatel|One Touch|ALCATEL ONE TOUCH 5036A|ALCATEL ONE TOUCH 5036A',
        #'Alcatel One Touch 6030A',
        'Alcatel|One Touch|ALCATEL ONE TOUCH 6030A|ALCATEL ONE TOUCH 6030A',
        'Alcatel|One Touch|ALCATEL ONE TOUCH 7040A|ALCATEL ONE TOUCH 7040A',
        'Alcatel|One Touch|ALCATEL ONE TOUCH 7041X|ALCATEL ONE TOUCH 7041X',
        'Alcatel|One Touch|ALCATEL ONE TOUCH 7042A|ALCATEL ONE TOUCH 7042A',
        'Alcatel|One Touch|ALCATEL ONE TOUCH 8000A|ALCATEL ONE TOUCH 8000A',
        'Alcatel|One Touch|ALCATEL_one_touch_995A|ALCATEL_one_touch_995A',
        'Alcatel|One Touch|ALCATEL ONE TOUCH Fierce|ALCATEL ONE TOUCH Fierce',
        #'Aqua Power+',
        #'Aquaris E4.5',
        #'ARGOM_E310',
        'Huawei|ASCEND|Ascend G510|Ascend G510',
        #'AT723C',
        'Toshiba|Excite|AT7-A|AT7-A',
        'Toshiba|Excite|AT7-B|AT7-B',
        'AVVIO|765|AVVIO 765|AVVIO 765',
        'AVVIO|775|Avvio_775|Avvio_775',
        'AVVIO|778|Avvio_778|Avvio_778',
        'AVVIO|785|Avvio 785|Avvio 785',
        'AVVIO|792|Avvio 792|Avvio 792',
        'BMobile|AX524|AX524|AX524',
        'BMobile|AX530|AX530|AX530',
        'BMobile|AX540|AX540|AX540',
        'BMobile|AX610|AX610|AX610',
        'BMobile|AX650|AX650|AX650',
        'BMobile|AX660|AX660|AX660',
        'BMobile|AX7OO|AX7OO|AX7OO',
        'BMobile|AX950|AX950|AX950',
        'Azumi|A50C|Azumi_A50c|Azumi_A50c',
        'Acer|Iconia Tab|B1-710|B1-710',
        'ALPS|B916E|B916E|B916E',
        #'Beeline Tab',
        'BLU|Advance 4.0|BLU ADVANCE 4.0|BLU ADVANCE 4.0',
        'BLU|Dash 3.5|BLU DASH 3.5|BLU DASH 3.5',
        'BLU|Dash Jr|BLU DASH JR|BLU DASH JR',
        'BLU|Neo 3.5|BLU Neo 3.5|BLU Neo 3.5',
        'BLU|Touch Book 7.0|BLU Touch Book 7.0 LITE|BLU Touch Book 7.0 LITE',
        'BMobile|AX620|Bmobile_AX620|Bmobile_AX620',
        'BMobile|AX650|Bmobile AX650|Bmobile AX650',
        'BMobile|AX690|Bmobile__AX690|Bmobile__AX690',
        'BMobile|AX745|Bmobile AX745|Bmobile AX745',
        'Barnes & Noble|NOOK HD|BNTV400|BNTV400',
        #'bq Edison',
        'Kurio|C14100|C14100|C14100',
        'Kyocera|Hydro VIBE|C6725|C6725',
        'Huawei|GPlay mini|CHC-U23|CHC-U23',
        #'CHERRY SNAP',
        'Cybertech|CT8ATQ|CT8ATQ|CT8ATQ',
        'Mobistel|Cynus E1|Cynus E1|Cynus E1',
        'AOC|D70J10|D70J10|D70J10',
        #'DigiJet Nanok',
        #'DROIDZ Edge',
        'ALPS|e1809c|e1809c_v75_gq1008_5640|e1809c_v75_gq1008_5640',
        'Sony|Xperia E4g|E2006|E2006',
        'Sony|Xperia E4|E2104|E2104',
        'EKT|KA 5926|ekt KA-5926|ekt KA-5926',
        'EKT|M1|EKT M1|EKT M1',
        'Energy Sistem|s10 Dual|ENERGY s10 DUAL|ENERGY s10 DUAL',
        'STOREX|eZee Tab1004|eZee\'Tab1004|eZee\'Tab1004',
        #'F1s',
        #'Fiiser',
        'Nyx|Fly Mini|FLY mini|FLY mini',
        'FNAC|3.0 10|fnac 3.0 10|fnac 3.0 10',
        'FNAC|4.5|fnac 4.5|fnac 4.5',
        #'FREE 8810',
        'Alps|G0775|G0775|G0775',
        'GFive|Spark A1|GFIVE Spark(A1)|GFIVE Spark(A1)',
        'GiGo|GG-2400|GG-2400|GG-2400',
        'Ghia|Any 27258B|GHIA 27258B|GHIA 27258B',
        'KYE|Genius Pad GP-720|GP-720|GP-720',
        'SAMSUNG|Galaxy Core|GT-I8200|GT-I8200',
        'HP|Slate 7|HP Slate 7|HP Slate 7',
        'Huawei|Ascend|HUAWEI G510-0200|HUAWEI G510-0200',
        'Huawei|Ascend|HUAWEI G510-0251|HUAWEI G510-0251',
        'Huawei|Premia|HUAWEI-M931|HUAWEI-M931',
        'Huawei|IDEOS X6|Huawei-U9000|Huawei-U9000',
        'Huawei|Ascend|HUAWEI Y210-0100|HUAWEI Y210-0100',
        'Huawei|Ascend|HUAWEI Y210-0151|HUAWEI Y210-0151',
        'Tesco|Hudl HT7S3|Hudl HT7S3|Hudl HT7S3',
        'Alcatel|Pixo7 I211|I211|I211',
        'iView|SupraPad i700|i700|i700',
        'Lenovo|IdeaTab A2109A|IdeaTabA2109A|IdeaTabA2109A',
        'Lanix|Ilium S106|ILIUM S106|ILIUM S106',
        'Lanix|Ilium S120|ILIUM S120|ILIUM S120',
        'Lanix|Ilium S410|ILIUM S410|ILIUM S410',
        'Vega|SKY Pantech Vega Iron|IM-A870S|IM-A870S',
        'i-mobile|IQ|i-mobile IQ 5.8 DTV|i-mobile IQ 5.8 DTV',
        #'ImPAD 3412',
        'Fly|IQ445 Genius|IQ445|IQ445',
        'Samsung|Galaxy J7|J7 QUAD CORE|J7 QUAD CORE',
        'Asus|Memo Pad 10 ME102A|K00F|K00F',
        'ASUS|ME180A|K00L|K00L',
        #'K1001L',
        'Likuid|L4 Per4mance|L4_Per4mance|L4_Per4mance',
        'Lark|Cirrus 4|Lark Cirrus 4|Lark Cirrus 4',
        'Lucas|Uno|LUCAS UNO|LUCAS UNO',
        'Samsung|Galaxy A|M100|M100',
        'M4TEL|M4 SS1050|M4 SS1050|M4 SS1050',
        'M4TEL|M4 SS1060|M4 SS1060|M4 SS1060',
        'M4TEL|M4 SS1070|M4 SS1070|M4 SS1070',
        'M4TEL|M4 SS4020|M4 SS4020|M4 SS4020',
        'M4TEL|M4 SS4040|M4 SS4040|M4 SS4040',
        'M4TEL|M4 SS4045|M4 SS4045|M4 SS4045',
        'M4TEL|M4 SS990|M4TEL SS990|M4TEL SS990',
        'Acteck|Bleck M729K|M729K MVTA-010|M729K MVTA-010',
        'Molvu|M7Q4|M7Q4|M7Q4',
        'Motorola|ATRIX 2|MB865|MB865',
        'ASUS|Memo Pad HD 7 ME173X|7ME173X|7ME173X',
        'Micromax|Bolt A069|Micromax A069|Micromax A069',
        'Micromax|A121 Canvas Elanza 2|Micromax A121|Micromax A121',
        'Coby|Kyros|MID8042|MID8042',
        #'Minion Pad',
        #'MI PAD',
        'Mito|A810 Fantasy Lite|MITO A810|MITO A810',
        'Mediacom|Smart PAD 7.0|M-MP720GO|M-MP720GO',
        'Cygnus|Yes MPY35|MPY35  |MPY35  ',
        'AOC|Breeze G7|MW0712|MW0712',
        'AOC|Breeze|MW0831|MW0831',
        'AOC|Breeze|MW0931|MW0931',
        'ZTE|Imperial N9101|N9101|N9101',
        'Nobis|NB07|NB07|NB07',
        'Krono|K5|NET_K5|NET_K5',
        'Woxter|Nimbus 101Q|Nimbus 101Q|Nimbus 101Q',
        'Kocaso|Nova|Nova|Nova',
        #'NOVO-1',
        #'NX007HD',
        'YIFANG|NX700G|NX700G|NX700G',
        'ALPS|NYX_NOBA_II|NYX_NOBA_II|NYX_NOBA_II',
        #'ONE 4',
        'ALCATEL|ONE TOUCH|ONE TOUCH 4016A|ONE TOUCH 4016A',
        'ALCATEL|ONE TOUCH|ONE TOUCH 4033A|ONE TOUCH 4033A',
        'ALCATEL|ONE TOUCH|ONE TOUCH 6012A|ONE TOUCH 6012A',
        'ALCATEL|ONE TOUCH|Orange Kivo|Orange Kivo',
        #'OZZY',
        'Prestigio|MultiPhone 5300 Duo|PAP5300DUO|PAP5300DUO',
        'Prestigio|MultiPhone 5400 Duo|PAP5400DUO|PAP5400DUO',
        'Philips|W8510|Philips W8510|Philips W8510',
        'Prestigio|Multipad 8.0|PMP5580C|PMP5580C',
        'Huawei|Prism II|Prism II|Prism II',
        'BlackBerry|Q10|Q10-1|Q10-1',
        'Micromax|Q7|Q7|Q7',
        'AOC|Q80Y31|Q80Y31|Q80Y31',
        #'Q8H',
        'QUO|BLAZE73Gm|QD3Gm-710|QD3Gm-710',
        'Quantum|Nuqleo Quantum 7|Quantum 7|Quantum 7',
        #'R70BC',
        #'RC0734H',
        #'RCT6272W23',
        #'RCT6773W22',
        ...
        #'rk30sdk',
        #'S1',
        'Inovacel|S23C|S23C|S23C',
        'PORTO|S708ET|S708ET|S708ET',
        'LG|Intuition VS950|S950|S950',
        'Genesis|SK-Mtek GT7305|SK-Mtek GT7305|SK-Mtek GT7305',
        'Samsung|Galaxy Note 10.1|SM-P600|SM-P600',
        'Solone|A47|SOLONE A47|SOLONE A47',
        'BLU|Studio 5.0|Studio 5.0LTE|Studio 5.0LTE',
        'Verykool|T742|T742|T742',
        #'TAB10IS',
        'ALPS|TB 650|TB-650-dual core|TB-650-dual core',
        #'TBJ-706',
        #'TM75A-V',
        #'TR720F',
        'Unimax|U670C|U670C|U670C',
        'Huawei|Honor|U8860|U8860',
        'Huawei|Ascend P1|U9200|U9200',
        #'UDI7012',
        #'UDI786',
        #'V01',
        'Alcatel|SMART KICKA|VF685|VF685',
        #'vi movil',
        'Vodafone|Smart Mini|Vodafone 875|Vodafone 875',
        #'W105',
        'Micromax|X210|X210|X210',
        'XPX|XM74|XM74|XM74',
        'Huawei|Ascend Y320|Y320-U151|Y320-U151',
        'BlackBerry|Z10|Z10|Z10',
        'ZTE|Kis|ZTE V768|ZTE V768']

    UniqueDevice.all.each do |u_device|
      if u_device.device_brand == '' || u_device.device_name == ''
        entry_key = nil
        big_list.each do |entry|
          if entry.downcase.include?("|#{u_device.device_device}|".downcase)
            entry_key = entry
            break
          end
        end
        ...
        if entry_key.nil?
          big_list.each do |entry|
            if entry.downcase.end_with?("|#{u_device.device_model}".downcase)
              entry_key = entry
              break
            end
          end
        ...
        if entry_key
          entry_split = entry_key.split('|')
          u_device.device_brand = entry_split[0]
          u_device.device_name = entry_split[1]
          u_device.save
        end
      end
    end
